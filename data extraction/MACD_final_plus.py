...
'''
'A005930','A000660','A035420','A005935','A051910','A005380','A207940','A035720','A006400','A068270',
'A000270','A005490','A012330','A066570','A051900','A028260','A105560','A036570','A017670','A096770',
'A055550','A034730','A032830','A003550','A090430','A015760','A018260','A009150','A086790','A003670',
'A033780','A251270','A302440','A011170','A018880','A011200','A010950','A000810','A009830','A326030',
'A009540','A034220','A352820','A010130','A316140','A086280','A011780','A030200','A024110','A097950',
'A180640','A128940','A028670','A005387','A006360',
'A241560','A078930','A026960','A047810','A003410','A004990','A023530','A008770','A016360','A204320',
'A039490','A285130','A005830','A336260','A005940','A012750','A012510','A008560','A036460','A007070',
'A006800','A004020','A035250','A019170','A161390','A032640','A002790','A271560','A011070','A069500',
'A139480','A000720','A071050','A003490','A021240','A034020','A006280','A000100','A088980','A267250',
'A010140','A011790','A008930','A000120','A029780'''
...
class CpStockChart:
    ...
    def Request(self, code, objSeries):
        #######################################################
        # 1. 일간 차트 데이터 요청
        self.objStockChart.SetInputValue(0, code)  # 종목 코드 -
        self.objStockChart.SetInputValue(1, ord('1'))  # 날짜로 조회
        self.objStockChart.SetInputValue(2, 20210323)  # 가장 최근 날짜
        self.objStockChart.SetInputValue(3, 20151101)  # 가장 오래된 날짜
...
class CpIndexTest:
    def __init__(self):
        ...
        '''for requestName in requestList:
            self.objChart.Request(requestName, 100, self.objSeries)'''
        self.objChart.Request(jongmoc, self.objSeries)

    # 플러스에서 제공하는 모든 지표와 지표의 기본 조건 나열 -> date 추가로 기능 바꿈
    def listAllIndex(self):
        global jongmoc
        dict={'Date': self.objChart.date}
        with open('%s.csv' % jongmoc ,'a', encoding='UTF-8') as f:
...
class MyWindow(QMainWindow):
    ...
    def initIndexInfo(self):
        ...
        self.indexList['이동평균(라인3개)'] =['MA_5','MA_20','MA_60']
        self.indexList['Stochastic Slow'] = ['SLOW_K', 'SLOW_D']
        self.indexList['MACD'] = ['MACD', 'MACD_SIGNAL', 'MACD_OSCILLATOR']
        self.indexList['RSI'] = ['RSI', 'RSI_SIGNAL']
        self.indexList['Binary Wave MACD'] = ['BWMACD','BWM_SIGNAL', 'BWM_OSCILLATOR']
        self.indexList['TSF'] = ['TSF','TSF_SIGNAL']
        self.indexList['ZigZag'] = ['ZigZag1', 'ZigZag2']
        self.indexList['Bollinger Band'] = ['Bol_UP', 'Bol_DOWN', 'Bol_MID']
        self.indexList['OBV'] = ['OBV', 'OBV_SIGNAL']
        self.indexList['Volume Ratio'] = ['VR','VR_SIGNAL']
